    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm" onClick={handleBackdropClick}>
      <div className="relative max-w-md w-full mx-4">
        ...
        <div style={{ perspective: "1000px" }} className="w-full">
          ...
          >
            <div className="relative w-full mb-4" style={{ aspectRatio: "3 / 4", background: "#0a0a0a", borderRadius: 16, overflow: "hidden" }}>
              <img
                loading="lazy"
      ...
      <div className="w-full h-screen relative overflow-hidden bg-black">
        ...
        >
          <a
            ...
            onMouseEnter={(e) => { e.currentTarget.style.color = "#fff"; e.currentTarget.style.background = "rgba(49,184,198,0.4)"; }}
            onMouseLeave={(e) => { e.currentTarget.style.color = "rgba(255,255,255,0.7)"; e.currentTarget.style.background = "rgba(0,0,0,0.6)"; }}
          >
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="m15 18-6-6 6-6" /></svg>
            Back to Home
          </a>
          <h1 style={{ color: "#fff", fontSize: 24, fontWeight: 700, marginBottom: 8, textShadow: "0 2px 8px rgba(0,0,0,0.8)" }}>3D Stellar Card Gallery</h1>
          <p style={{ color: "rgba(255,255,255,0.5)", fontSize: 14, textShadow: "0 2px 8px rgba(0,0,0,0.8)" }}>Drag to look around • Scroll to zoom • Click cards to view details</p>
        </div>
      </div>
    </CardProvider>
  );
